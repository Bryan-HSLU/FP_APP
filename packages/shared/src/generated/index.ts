...
export * as projekt from "./projekt.ts";
export * as raummodell from "./raummodell.ts";
export * as regel from "./regel.ts";
export * as stilprofil from "./stilprofil.ts";
export * as taxonomie from "./taxonomie.ts";
